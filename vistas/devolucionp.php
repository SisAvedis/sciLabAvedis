              ...
              <div class="col-md-12">
                  <div class="box">
                    <div class="box-header with-border">
                          <h1 class="box-title">Devolucion <button class="btn btn-success" id="btnagregar" onclick="mostrarform(true,true)"><i class="fa fa-plus-circle"></i> Agregar</button></h1>
					...
					<div class="panel-body" style="height: 400px;" id="formularioregistros">
                        <form name="formulario" id="formulario" method="POST">
                          <div class="form-group col-lg-4 col-md-4 col-sm-4 col-xs-12">
                            ...
                            <input type="hidden" name="iddevolucionp" id="iddevolucionp">
                          ...
                          <div class="form-group col-lg-2 col-md-2 col-sm-2 col-xs-12">
                            ...
                            <select name="tipo_comprobante" id="tipo_comprobante" class="form-control selectpicker" required="">
                               <option value="Orden de Devolucion">Devolucion</option>
...
require 'footer.php';
?>
<script type="text/javascript" src="scripts/devolucionp.js"></script>
<?php 
}
ob_end_flush();
?>
